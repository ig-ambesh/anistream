...
import { searchTMDB, getDetails, getTrending, getAnimeTrendingHandler, getAnimeNewReleasesHandler, getAnimeHighRatedHandler } from '../../controllers/tmdb/tmdb.controller';
